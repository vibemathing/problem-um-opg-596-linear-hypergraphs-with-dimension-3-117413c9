...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-596"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-v1",
      "problem_contract_sha256": "c12fc5b1a3e1fa68ab71f65409e21bf8104768184024c0ca5f534fb3bb8e0968",
      "problem_id": "problem:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9",
      "route_id": "route:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-source-fidelity-01",
      "graph_id": "graph:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Any linear hypergraph with incidence poset of dimension at most 3 is the intersection hypergraph of a family of triangles and segments in the plane."
          },
          "statement_sha256": "b0798c060a51939c5622e543c1c8921a1fd3b0d558db3160102a0e7c973df1b8"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-root",
      "route_id": "route:um-opg-596-linear-hypergraphs-with-dimension-3-117413c9-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-596-bf4549dcb397",
        "url": "https://www.unsolvedmath.com/problems/OPG-596"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
